    ...
    return (
        <article css={css`min-height:150px;
            ...
            <div css={css`display:flex; justify-content: space-between; margin-bottom:1em;`}>
                ...
                <div css={css`width:20%; height:5em; ${SkeletonColor()}; ${media.sm`width:25%; height:4em;`}`}></div>
            </div>

            <div css={css`margin-bottom:1em;`}>
                {[1, 2, 3].map((item,index) => {
                    return (
                        <div key={index} css={css`display:inline-block; width:3em; height:1.5em; ${SkeletonColor()}; margin-right:0.5em;`}></div>
                    )
                })}
            </div>
            ...
            <div css={css`display:flex; justify-content: space-between; margin-top:1em;`}>
                <div>
                    ...
                    <div css={css`display:inline-block; width:4em; height:1.2em; ${SkeletonColor()};`}></div>
                </div>
                <div>
                    <div
                        css={css`display:inline-block; width:4em; height:1.2em; ${SkeletonColor()}; margin-right:0.5em;`}></div>
